    ...
    public static class SwaggerConfiguration
    {
        ...
        public static void Configure(SwaggerGenOptions option)
        {
            option.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "Service of transactions control managing the cash flow , including opening, closing, and calculating the cash consolidate. APIs to open/close cash, balance",
